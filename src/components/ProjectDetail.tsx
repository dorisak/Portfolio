...
const ClaudeIcon = ({ size = 14, className = "" }: { size?: number, className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M12 10.5L14.5 2L15.5 2.5L13.5 11L21.5 6.5L22 7.5L14 12L22 16.5L21.5 17.5L13.5 13L15.5 21.5L14.5 22L12 13.5L9.5 22L8.5 21.5L10.5 13L2.5 17.5L2 16.5L10 12L2 7.5L2.5 6.5L10.5 11L8.5 2.5L9.5 2L12 10.5Z" fill="currentColor" />
  </svg>
);

const GeminiIcon = ({ size = 14, className = "" }: { size?: number, className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M12 0C12 0 12.5 10 24 12C12.5 14 12 24 12 24C11.5 14 0 12 11.5 10C11.5 10 12 0 12 0Z" fill="url(#gemini-gradient)" />
    <defs>
      <linearGradient id="gemini-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#E66C7B" />
        <stop offset="33%" stopColor="#F2B035" />
        <stop offset="66%" stopColor="#5B95F9" />
        <stop offset="100%" stopColor="#4DBF85" />
      </linearGradient>
    </defs>
  </svg>
);
    ...
    >
      ...
      <div className="max-w-6xl mx-auto p-6 md:p-12 lg:p-20">
        ...
        <section className="mb-32">
          <span className="text-[10px] font-bold uppercase tracking-widest text-brand-dark/40 mb-4 block">
            Objectifs visés
          </span>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  <div className="lg:col-span-4">
                    <span className="text-brand-blue font-mono text-xs mb-4 block">_0{i+1}</span>
                  ...
                  <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="md:col-span-2 bg-brand-bg p-6 rounded-2xl border border-brand-dark/5">
                      ...
                      <p className="text-base font-medium mb-4">{dec.decision}</p>
                      {dec.implementation && (
                        <div className="mt-4 pt-4 border-t border-brand-dark/5">
                          <p className="text-[10px] font-bold uppercase tracking-widest text-brand-dark/30 mb-3">Implémentation</p>
                          <ul className="space-y-2">
                            {dec.implementation.map((item, idx) => (
                              <li key={idx} className="flex items-start gap-2 text-xs text-brand-dark/70">
                ...
                {project.stack?.map((tech, i) => {
                  ...
                  return (
                    <span key={i} className="px-4 py-2 bg-brand-dark text-white rounded-full text-[10px] font-bold uppercase tracking-widest flex items-center">
                      ...
                      {isGemini && <GeminiIcon className="mr-2" />}
                      {tech}
                    </span>
                  );
                })}
